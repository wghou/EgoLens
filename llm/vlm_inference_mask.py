...
class EgoAffordDataset(Dataset):
    ...
    def __init__(self, base_dir):
        ...
        self.question_template = (
            "Goal: '{main_task}'\n"
            "Current action step: '{current_step}'\n"
...
if __name__ == "__main__":
    ...
    if os.path.exists(os.path.join(output_dir, f"{args.type}_mask.json")):
        with open(os.path.join(output_dir, f"{args.type}_mask.json"), 'r') as f:
    ...
    with open(os.path.join(output_dir, f"{args.type}_mask.json"), 'w') as f:
